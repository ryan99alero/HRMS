                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' style='border-radius:8px;' data-id='".$row['caid']."'><i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-danger btn-sm delete btn-flat' style='border-radius:8px;' data-id='".$row['caid']."'><i class='fa fa-trash'></i> Delete</button>
                          </td>
                        </tr>
                      ";
                    }
