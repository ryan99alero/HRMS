                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm btn-flat edit' style='border-radius:8px;' data-id='" . $row['attid'] . "'><i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-danger btn-sm btn-flat delete' style='border-radius:8px;' data-id='" . $row['attid'] . "'><i class='fa fa-trash'></i> Delete</button>
                          </td>
                        </tr>
                      ";
                                }
